...
:::warning
This guide may not be fully complete due to a lack of an Intel-based MacBook to test the process. If you have an Intel-based MacBook and would like to contribute to this guide, please refer to the [GitHub repository](https://github.com/Camuise/MultiSim-Guide).
:::
